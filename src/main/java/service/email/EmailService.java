...
public class EmailService {
    ...
    private Properties loadConfig() {
        ...
        try {
            if (!loadProperties(p, EmailService.class, CONFIG_PATH)) {
    ...
    static boolean loadProperties(Properties properties, Class<?> classAnchor, String path) throws IOException {
        try (InputStream in = classAnchor.getResourceAsStream(path)) {
